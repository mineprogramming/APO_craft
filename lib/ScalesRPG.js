...
var ScalesRPG = {
    Scale: function(parameters){
        //Getting bitmaps
        var bmpFull = BitmapFactory.decodeFile(__dir__ + "gui/" + parameters.textures.full + ".png");
        var bmpHalf = BitmapFactory.decodeFile(__dir__ + "gui/" + parameters.textures.half + ".png");
        var bmpEmpty = BitmapFactory.decodeFile(__dir__ + "gui/" + parameters.textures.empty +".png");
