...
runAsUI(function(){
    ...
    //Containers for left- and right-side scales
...
var ScalesRPG = {
    Scale: function(parameters){
        ...
        var defaultValue = parameters.defaultValue == undefined? 20: parameters.defaultValue;
        var value = parameters.value == undefined? defaultValue: parameters.value;
