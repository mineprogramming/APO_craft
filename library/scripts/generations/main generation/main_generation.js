...
Roads.generateSimpleRoad = function(x, y, z, directionZ){
    ...
    if(directionZ){
        ...
        for(var i = 0; i < 16; i++){
            ...
            bufferSetTile(x + 1, y, z + i, ID_ASPHALT, 0);
            bufferSetTile(x + 2, y, z + i, ID_ASPHALT, 1);
            bufferSetTile(x + 3, y, z + i, ID_ASPHALT, 0);
            bufferSetTile(x + 4, y, z + i, ID_ASPHALT, 4);
			bufferSetTile(x + 1, y+1, z + i, 0);
            bufferSetTile(x + 2, y+1, z + i, 0);
            bufferSetTile(x + 3, y+1, z + i, 0);
            bufferSetTile(x + 4, y+1, z + i, 0);
